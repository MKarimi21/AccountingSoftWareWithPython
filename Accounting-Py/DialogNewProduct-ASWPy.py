...
# Form implementation generated from reading ui file 'DialogNewProduct-ASWPy.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "کالای غیر مشابه را وارد کنید. درصورت مشابه بودن اضافه نخواهد شد."))
        self.label_2.setText(_translate("Dialog", "نام کالا:"))
        self.label_3.setText(_translate("Dialog", "کد کالا:"))
        self.pushButton.setText(_translate("Dialog", "اضافه کردن کالا"))
